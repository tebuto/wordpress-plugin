...
function tebuto_shortcode_page(): void {
	...
	<div class="wrap tebuto-admin-wrap">
		...
		<?php if ( isset( $_GET['saved'] ) ) : // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Read-only flash flag from post-save redirect. ?>
	...
	jQuery(document).ready(function($) {
		...
		const managedAccountEventsDefaultHelp = 
		<?php
		echo wp_json_encode(
		...
		?>
		;
		const managedAccountEventsAutoHelp = 
		<?php
		echo wp_json_encode(
