...
function tebuto_admin_page()
{
    ...
    if (!$refresh_token) {
        ...
        echo '<img class="tebuto-icon" style="height: 60px; width: auto;" src="' . esc_url(TEBUTO_PLUGIN_URL . 'assets/tebuto_icon.png') . '" alt="' . esc_attr__('Tebuto Icon', 'tebuto-online-terminbuchung') . '" />';
